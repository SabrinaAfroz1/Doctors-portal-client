...
import { useUpdateProfile, useSignInWithGoogle, useCreateUserWithEmailAndPassword } from 'react-firebase-hooks/auth';
            ...
            <div className="card w-96 bg-base-100 shadow-xl">
                <div className="card-body">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input className='btn w-full max-w-xs mb-5 mt-5' type="submit" value="Sign up" />
                        <p className='text-sm'>Already Have An Account ? <Link className='text-secondary' to="/login">Login</Link> </p>
                    </form>
